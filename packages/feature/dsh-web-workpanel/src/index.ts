 ...
 *   GET /web-workpanel/pdfjs/<allowlisted-asset>
 *       PDF.js runtime, worker, viewer, fonts, color maps and WASM resources.
 *   WS  /web-workpanel/terminal?session=<id>&terminal=<id>&cols=<n>&rows=<n>
 ...
 *
 * @module @neplich/dsh-web-workpanel
 */
...
export const name = 'web-workpanel'
...
export function apply(ctx: Context, config: Config) {
  ...
  }), 'web-workpanel: terminal close route')
  ...
  }), 'web-workpanel: terminal route')

  ctx.effect(() => () => { void terminals.dispose() }, 'web-workpanel: PTY cleanup')
