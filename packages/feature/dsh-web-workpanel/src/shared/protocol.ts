 ...
 *
 * @module @neplich/dsh-web-workpanel/shared
 */
...
/** Body of GET /web-workpanel/list. */
...
/** Body of GET /web-workpanel/read. */
...
export const ROUTES = {
  list: '/web-workpanel/list',
  read: '/web-workpanel/read',
  raw: '/web-workpanel/raw',
  pdfJs: '/web-workpanel/pdfjs',
  ooxml: '/web-workpanel/ooxml',
  terminal: '/web-workpanel/terminal',
  terminalClose: '/web-workpanel/terminal/close',
} as const
